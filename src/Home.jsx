...
function Home() {
  ...
  const targetMonthlyBudget = 50000; 
  ...
  <div className="logo">ExpenseAI</div>
  <div className="user-info">
    ...
    <button onClick={() => signOut(auth)} className="logout-btn">Logout</button>
      ...
      <div className="container">
        ...
        <h3 style={{ textAlign: 'center', color: total > targetMonthlyBudget ? 'red' : 'green' }}>
  {total > targetMonthlyBudget
    ? "⚠ Over budget by ₹" + (total - targetMonthlyBudget)
    : "✅ Savings: ₹" + (targetMonthlyBudget - total)}
</h3>
        
        
        <CategoryPieChart data={filteredExpenses} />
        <MonthlyBarChart data={filteredExpenses} />
